...
<?php else : ?>
	...
	<?php elseif ( is_tax() ) : ?>
		...
		?>
	<?php elseif ( 'product' === get_post_type( $post_id ) && function_exists( 'wc_placeholder_img_src' ) && wc_placeholder_img_src() ) : ?>
		<?php echo wc_placeholder_img( $post_featured_image_size ); ?>
